...
wordcloud(words = sf_keywords_all$single_term, freq = sf_keywords_all$n, min.freq = 5,
...
```{r}
wordcloud(words = sf_keywords_third$third_term, freq = sf_keywords_third$n, min.freq = 5,
...
```{r}
wordcloud(words = sf_keywords_root$root_term, freq = sf_keywords_root$n, min.freq = 5,
          max.words=50, random.order=FALSE, rot.per=0.35, 
          colors=brewer.pal(8, "Dark2"))
```
...
```{r}
wordcloud(words = AILD_keywords$single_term, freq = AILD_keywords$n, min.freq = 5,
          max.words=200, random.order=FALSE, rot.per=0.35, 
          colors=brewer.pal(8, "Dark2"))
```
